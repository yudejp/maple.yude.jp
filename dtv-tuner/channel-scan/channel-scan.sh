...
# example: recpt1
readonly RECORD_COMMAND_GR='recpt1 --device /dev/isdb6014video0 <channel> <record_second> <output>'
readonly RECORD_COMMAND_BSCS='recpt1 --device /dev/isdb6014video0 <channel> <record_second> <output>'
# example: dvbv5-zap
